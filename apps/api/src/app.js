...
import discountRoutes from './routes/v1/discount.routes.js';
...
import storefrontCustomerRoutes from './routes/storefront/sf.customer.routes.js';
...
app.use('/api/v1/storefront', storefrontCustomerRoutes);
